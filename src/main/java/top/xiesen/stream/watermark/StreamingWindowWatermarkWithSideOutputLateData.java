 ...
 */
public class StreamingWindowWatermarkWithSideOutputLateData {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 注意，由于 getSideOutput 方法是 SingleOutputStreamOperator 子类中特有的方法，所以在这里不能使用父类 DataStream
        SingleOutputStreamOperator<String> windowData = watermarkStream.keyBy(0)
        ...
        // 把延迟的数据暂时打印到控制台,实际中可以保存到其他存储介质中
        DataStream<Tuple2<String, Long>> sideOutput = windowData.getSideOutput(outputTag);
        sideOutput.print();

        // 测试-把结果打印到控制台
        windowData.print();
        env.execute(StreamingWindowWatermarkWithSideOutputLateData.class.getSimpleName());
    }
}
