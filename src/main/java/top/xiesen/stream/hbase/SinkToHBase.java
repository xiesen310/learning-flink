...
public class SinkToHBase extends RichSinkFunction<List<MysqlBinModel>> {
...
//            conn = ConnectionFactory.createConnection(config);
    ...
    @Override
    public void invoke(List<MysqlBinModel> value, Context context) throws Exception {
        int t = 0;
        //遍历数据集合
        for (MysqlBinModel mysqlBinModel : value) {
//            System.out.println("databases:" + student.getDatabase());
//            System.out.println("data:" + student.getData());
//
            JSONObject jsonData = JSON.parseObject(mysqlBinModel.getData());
